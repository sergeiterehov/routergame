...
Порты устройств и драйвера знают о наличии линка (флаг RUNNING). Наличие линка определяет регулярное прохождения маячкового сигнала.
...
2. декларативно - демон `netd` применяет изменения конфигурационного файла в ОС, утилита `net` для безопасного редактирования конфигурационного файла из консоли.
